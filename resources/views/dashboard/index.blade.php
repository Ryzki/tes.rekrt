...
<section class="container py-2">
    @if($selection != null)
        ...
        @endif
    @endif
    {{-- 1: ; 2:hrd ;3:employee; 5:general; 8:student--}}
    @if(Auth::user()->role_id == role('super-admin') || Auth::user()->role_id == 8 || Auth::user()->role_id == 2 || Auth::user()->role_id == 3 || Auth::user()->role_id == 5)
    <div class="content">
