			...
			<div class="card">
				...
				<div class="card-body">
					<form id="form" method="post" action="/tes/{{ $path }}/store">
						...
						<input type="hidden" name="packet_id" value="{{ $soal->id }}">
						<input type="hidden" name="test_id" value="{{ $test->id }}"> 
						<input type="hidden" name="jumlah_soal" class="jumlah_soal" value="{{ $soal->amount }}"> 
...
@section('js-extra')
<script type="text/javascript" src="{{ asset('assets/js/cifit.js') }}"></script>
