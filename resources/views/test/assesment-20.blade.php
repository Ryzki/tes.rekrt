...
<div class="bg-theme-1 bg-header">
    <div class="container text-center text-white">
        ...
        <p class="m-0"><b>ITEM 1-16</b> : Terdapat soal dan 3 pernyataan yang disiapkan, peserta didik dapat memilih salah satu diantara pernyataan tersebut yang menggambarkan dirinya</br><b>Baca dengan seksama uraian kuisioner dibawah ini dan Pilih salah satu jawaban a / b / c sesuai kecenderungan anda.</b></p>
    </div>
</div>
					    ...
					    <div class="col-12">
                            <div class="card soal rounded-1 mb-3">
                      			<div class="card-header bg-transparent">
					    			<span class="num fw-bold"><i class="fa fa-edit"></i> Soal {{$question['id']}} {{$question['soal']}} </span>
					    		</div>
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        <tr>
                                            <td>
												...
												<div class="custom-control custom-radio mt-3">
                                                    <input type="radio" class="form-check-input radio{{$question['id']}}"
                                                        id="customRadio{{$question['id']}}c" name="p[{{$question['id']}}]"
                                                        value="C">
                                                    <label class="custom-control-label text-justify" for="customRadio{{$question['id']}}c">
                                                        <span>
                                                            {{$question['pilihan3']}}
                                                        </span>
                                                    </label>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
	    	<div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	...
		        	<p>Tes ini terdiri dari 16 Soal dan 1 jawaban setiap soal. Jawab secara jujur dan spontan. Estimasi waktu pengerjaan adalah 5-10 menit.</p>
